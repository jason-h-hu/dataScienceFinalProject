...
def regression():
    ...
    print "size of data is " + str(X_train)
    # The coefficients
    print('Coefficients: \n', regr.coef_)
    print(" X_test = [[5.0,0,1000],[5.0,50,1000],[4.5,0,450], [4.5,-50,450],[4.9,0,455],[4.6,0,2],[4.6,2.1,2],[4.6,2.1,2],[1,0,5000],[1,25,5000],[1.1,0,5],[2,0,300]]")
    X_test = [[5.0,0,1000],[5.0,50,1000],[4.5,0,450], [4.5,-50,450],[4.9,0,455],[4.6,0,2],[4.6,2.1,2],[4.6,2.1,2],[1,0,5000],[1,25,5000],[1.1,0,5],[2,0,300]]
